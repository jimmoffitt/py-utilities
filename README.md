...
### [Go to e-store.py](./data-generators)  
Generates e-store events and streams them to Tinybird. Manages a set of customers and products and generates product events: `view`, `cart`, `uncart`, `purchase`, and `return`.
